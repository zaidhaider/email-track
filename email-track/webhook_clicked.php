...
if($file)
{
    ...
    if($row_count==0)
    {
         ...
         try
        {
            $sql_final="INSERT INTO taginfos (_id,_tags,_email,open_rate,click_rate,_events,_state,_versions,_date) VALUES('".$_id."','".$_tags."','".$_email."','".$_opened."','".$_clicked."','".$_events."','".$_state."','".$version1."',NOW())";
